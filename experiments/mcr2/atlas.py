"""
ATLAS — autonomous child agent (Experiment #2)
===============================================
...
is denied or held, reason about alternative tools that could achieve the same
effect. You may set request_auth=true if you believe an action needs approval.
